...
const About = () => {
  ...
  return (
    <div className="bg-bg-color min-h-screen">
      ...
      <section
        id="who-we-are"
        className="py-16 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 scroll-mt-24"
      >
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white p-6 rounded-xl shadow-sm border-l-4 border-accent">
                ...
                <p className="text-gray-600 text-sm">
                  ...
                  and continuously improve our interventions.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-500">
              Find answers to common questions about our operations and impact.
            </p>
          </div>
